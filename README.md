...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.6.6-c41e3a?style=flat-square" alt="Version 2.6.6" />
...
**[⬇ Download Kill-Chain-Setup-2.6.6.exe](https://github.com/JerryKoller/Kill-Chain/raw/main/Kill-Chain-Setup-2.6.6.exe)**

| | |
|---|---|
| **Version** | 2.6.6 |
| **File** | `Kill-Chain-Setup-2.6.6.exe` |
| **Size** | ~77 MB |
...
2. Run `Kill-Chain-Setup-2.6.6.exe` and follow the setup wizard.
...
**v2.6.6 highlights:** Signal Path fills the bay · Natural Selection lineage · keyboard 1/2 octaves · band color map.
