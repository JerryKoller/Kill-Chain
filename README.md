...
A new install boots **completely quiet**: Init patches only (no humming preset), empty sequencer, blank Airspace (no YouTube), and boot sound off. Your own saved presets still migrate if you upgrade.
