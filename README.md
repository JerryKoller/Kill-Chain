...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.6.5-c41e3a?style=flat-square" alt="Version 2.6.5" />
...
**[⬇ Download Kill-Chain-Setup-2.6.5.exe](https://github.com/JerryKoller/Kill-Chain/raw/main/Kill-Chain-Setup-2.6.5.exe)**

| | |
|---|---|
| **Version** | 2.6.5 |
| **File** | `Kill-Chain-Setup-2.6.5.exe` |
| **Size** | ~77 MB |
...
2. Run `Kill-Chain-Setup-2.6.5.exe` and follow the setup wizard.
...
**v2.6.5 highlights:** Signal Path Theater + Command Map + Focus Mode — jump any stage, solo one bay.
