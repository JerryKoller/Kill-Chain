      ...
      <div className="relative z-10 flex flex-col justify-center gap-1 min-w-[148px] flex-1">
        <div className="flex items-center gap-1.5">
          ...
          <div className="min-w-0">
            <div className="text-[9px] font-black uppercase tracking-[0.2em] text-emerald-200/90 leading-none">
              Natural Selection
            </div>
        ...
        <button
          onClick={breed}
          className={`group relative h-8 overflow-hidden rounded-xl border text-[11px] font-black uppercase tracking-[0.14em] transition ${
            mutation
        ...
        <div className="flex items-center gap-1.5 px-0.5">
          <span className="text-[8px] uppercase tracking-wider text-emerald-200/35">Mild</span>
          <input
            type="range"
            min={0}
            max={1}
          ...
          />
          <span className="text-[8px] uppercase tracking-wider text-lime-300/50">Wild</span>
        </div>
      </div>

      {mutation ? (
        <div className="relative z-10 flex items-center gap-1.5 pl-1 border-l border-emerald-400/20">
            ...
            {(["a", "b"] as const).map((w) => {
              ...
              return (
                <button
                  ...
                  className={`relative w-11 h-11 rounded-xl border text-[12px] font-black transition overflow-hidden ${
                    live
